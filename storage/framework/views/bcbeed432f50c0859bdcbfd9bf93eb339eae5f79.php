...
<?php $rentableController = app('App\Http\Controllers\RentablesController'); ?>
...
<?php $component->withAttributes([]); ?>
                ...
                <div class="selected-row">
                    ...
                    <div class = "product-imgs">
                        <div class = "img-display">
                            ...
                            <?php elseif($rentable->status=='Pending'): ?>
                                <div class="stat-container">
                ...
                <div class="selected-row">
                    ...
                    <div class="about-seller-and-chat">
                        ...
                        <div class="chat-seller">
                            <?php
                                $type = null;
                                if($rentable instanceof \App\Models\Rentable){
                                    $type="rentable";
                                }
                                elseif($rentable instanceof \App\Models\Rentable){
                                    $type="rentable";
                                }
                                else {
                                    $type="lease";
                                }
                                // this is the rentable owner
                                $itemID = $rentable->id;
                                $ownerID = $rentable->user_id;
    ...
    <script>
        ...
        /*function initMap() {
            var mapTwo;
            var geocoder;
            var rentableLat = "<?php echo e($rentable->latitude); ?>";
            var rentableLong = "<?php echo e($rentable->longitude); ?>";
        ...
        var rentable_id = "<?php echo e($rentable->id); ?>"
        var rentableOwner = "<?php echo e($rentable->user_id); ?>";
