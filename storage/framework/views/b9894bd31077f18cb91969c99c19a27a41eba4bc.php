        ...
        <div class="showRandomItem" id="showRandomItem">
            ...
            <?php if($randomItem != null): ?>
                <?php if($randomItem instanceof App\Models\Listing): ?>
                    ...
                    <a class="view-item type-sale" href="/listings/<?php echo e($randomItem->id); ?>" >Buy</a>
                <?php elseif($randomItem instanceof App\Models\Rentable): ?>
                    ...
                    <a href="/rentables/<?php echo e($randomItem->id); ?>" class="view-item type-rent">Rent</a>
                <?php else: ?>
                    ...
                    <a href="/subleases/<?php echo e($randomItem->id); ?>" class="view-item type-lease">Lease</a>
                <?php endif; ?>
            <?php else: ?>
                <?php
