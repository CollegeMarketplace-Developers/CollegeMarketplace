...
<?php $component->withAttributes([]); ?>
                ...
                <div class="selected-row">
                    <div class ="description-chat">
                        <div class="product-description-area">
                            <div class="controls">
                                ...
                                <?php if($currentUser != null and $leaseItem->user_id == $currentUser->id): ?>
                                    <form method="POST" action="/leaseItems/<?php echo e($leaseItem->id); ?>/update">
                                        <?php echo csrf_field(); ?>
                                    ...
                                    <form class = "editForm" action="/leaseItems/<?php echo e($leaseItem->id); ?>/edit" method = "GET">
                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" name="id" value="<?php echo e($leaseItem->id); ?>">
                        ...
                        <div class="chat-container">
                            ...
                            <?php if($currentUser != null && $leaseItem->user_id == $currentUser->id): ?>
                            ...
                            <div id="scroll-to-bottom" class="messages-container active">
                                ...
                                <?php else: ?>
                                    ...
                                    <a class="back-placeholder">
                                        Chat with <?php echo e($leaseItem->first_name); ?> <?php echo e($leaseItem->last_name); ?>
        ...
        <div class="modal" id="delete-modal">
            <div class="modal-content">
                ...
                <div class="clearfix">
                    ...
                    <form method="POST" action="/leaseItems/<?php echo e($leaseItem->id); ?>">
                        <?php echo csrf_field(); ?>
    ...
    <script>
        ...
        /*function initMap() {
            var mapTwo;
            var geocoder;
            var leaseItemLat = "<?php echo e($leaseItem->latitude); ?>";
            var leaseItemLong = "<?php echo e($leaseItem->longitude); ?>";
        ...
        var leaseItem_id = "<?php echo e($leaseItem->id); ?>"
        var leaseItemOwner = "<?php echo e($leaseItem->user_id); ?>";
