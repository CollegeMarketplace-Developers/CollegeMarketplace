        ...
        <div class="profile-container">
            ...
            <div class="show-panel" id="main-panels-container">
                ...
                <div class="myPosts-main">
                    @include('partials._cardGallary', ['listings' => $myListings, 'heading'=>'My Listings', 'displayTags' => false, 'displayMoreButton' => false, 'currentUser' => $currentUser])
                </div>
                <div class="favorites-main">
                    @include('partials._cardGallary', ['listings' => $likedList, 'heading'=>'Liked Items', 'displayTags' => false, 'displayMoreButton' => false, 'currentUser'=>$currentUser])
                </div>
