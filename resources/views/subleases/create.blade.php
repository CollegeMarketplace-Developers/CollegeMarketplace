                ...
                <div class = "listingFormContainer">
                    ...
                    enctype="multipart/form-data">
                        ...
                        <section class = "listingCard default-card">
                            ...
                            <input type="text" name = "location" placeholder="General Location" maxlength = "80" onkeydown="javascript: return event.keyCode == 189 ? false : true" value="{{ old('location', null) }}" />
                            @error('location')
                                <p>{{$message}}</p>
                            @enderror
