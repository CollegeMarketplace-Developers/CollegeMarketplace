                ...
                <div class = "listingFormContainer">
                    ...
                    enctype="multipart/form-data">
                        ...
                        <section class = "listingCard default-card">
                            ...
                            onchange="try{setCustomValidity('')}catch(e){}"  oninput="setCustomValidity(' ')" maxlength = "80" novalidate value="{{ old('item_name', null) }}" />
                            @error('item_name')
                                <p>{{$message}}</p>
                            @enderror
                            ...
                            onchange="try{setCustomValidity('')}catch(e){}"  oninput="setCustomValidity(' ')" maxlength = "8" novalidate value="{{ old('price', null) }}" id="price-input"/>
                            @error('price')
                                <p>{{$message}}</p>
                            @enderror
